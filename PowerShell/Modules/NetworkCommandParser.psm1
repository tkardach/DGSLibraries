...
function Parse-Netstat
{
	...
	#>
	Param(
		[parameter(mandatory=$true,helpmessage="Netstat -na return value in string form")]
...
#>
    Param (
		[parameter(mandatory=$true,helpmessage="ipconfig /all in string form")]
		[system.array]$Results
    )
	Begin
	{
